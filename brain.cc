...
Position Brain::GetPutPoint(Board board) {
  ...
  put_point = board.FindLeadWinningPoint(4, own_stone(), 0);
  if (put_point.Exists()) {
    return put_point;
  }
  ...
  put_point = board.FindLeadWinningPoint(4, opponent_stone(), 0);
  if (put_point.Exists()) {
    return put_point;
  }
  ...
  put_point = board.FindLeadWinningPoint(3, own_stone(), 0);
  if (put_point.Exists()) {
    return put_point;
  }
